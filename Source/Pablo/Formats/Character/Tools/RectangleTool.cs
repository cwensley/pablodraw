...
namespace Pablo.Formats.Character.Tools
{
	public class RectangleTool : CenterAspectTool, ICharacterSelectSource
	{
		...
		public override Eto.Drawing.Image Image {
			get { return Eto.Drawing.Bitmap.FromResource ("Pablo.Formats.Rip.Icons.Rectangle.png"); }
		}
		...
		public override Key Accelerator {
			get {
				return Key.R | (Handler.Generator.IsMac ? Key.Control : Key.Alt);
			}
		}
		...
		{
			var control = new ImageButton{
				Image = Bitmap.FromResource ("Pablo.Formats.Rip.Icons.FilledRectangle.png"),
				Toggle = true,
				Pressed = Filled,
#if DESKTOP
