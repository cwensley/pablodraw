...
{
	public class OvalPieSlice : RipCommand
	{
		public class Type : RipCommandType<OvalPieSlice>
		{
		...
		{
			BGI.Sector (Point.X, Point.Y, StartAngle, EndAngle, Radius.Width, Radius.Height, updates);
		}
	}
}
